...
// Middleware
app.use(cors({
  origin: ['https://voice-airline-booking-1.onrender.com', 'https://voice-airline-booking-2.onrender.com', 'https://voice-airline-frontend.onrender.com', 'http://localhost:5173', 'http://localhost:3000'],
  credentials: true
}));
